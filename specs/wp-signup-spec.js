...
testDescribe( 'Sign Up (' + screenSize + ')', function() {
	...
	test.describe( 'Sign up for a free site', function() {
		...
		test.describe( `Step ${stepNum}: Survey`, function() {
			...
			test.describe( `Step ${stepNum}: Site Title`, function() {
				stepNum++;

				test.it( 'Can see the site title page', function() {
					this.siteTitlePage = new SiteTitlePage( driver );
					return this.siteTitlePage.displayed().then( ( displayed ) => {
						return assert.equal( displayed, true, 'The site title page is not displayed' );
					} );
				} );

				test.it( 'Can set the site title', function() {
					return this.siteTitlePage.setSiteTitle( blogName );
				} );
			} );
	...
	test.describe( 'Sign up for a site on a premium paid plan coming in via /create as premium flow', function() {
		...
		test.describe( `Step ${stepNum}: Survey`, function() {
			...
			test.xdescribe( `Step ${stepNum}: Site Title`, function() {
				stepNum++;
	...
	test.describe( 'Partially sign up for a site on a business paid plan w/ domain name coming in via /create as business flow', function() {
		...
		test.describe( `Step ${stepNum}: Survey`, function() {
			...
			test.xdescribe( `Step ${stepNum}: Site Title`, function() {
				...
				test.it( 'Can set the site title', function() {
					return this.siteTitlePage.setSiteTitle( siteName );
				} );
			} );
