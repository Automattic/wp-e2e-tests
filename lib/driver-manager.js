...
const webDriverScriptTimeOutMs = 30000;
...
export function startBrowser( { useCustomUA = true, resizeBrowserWindow = true } = {} ) {
	...
	driver.manage().timeouts().setScriptTimeout( webDriverScriptTimeOutMs );
...
//	return driver.isElementPresent( webdriver.By.xpath( '//XCUIElementTypeImage[@name="icon-wp"]' ) ).then( function( atLoginScreen ) {
//		if ( ! atLoginScreen ) {
