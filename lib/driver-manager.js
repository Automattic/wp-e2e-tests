...
export function currentGutenbergEnvironment() {
	var gutenbergEnv = process.env.GUTENBERG_ENV;
	if ( gutenbergEnv === undefined || gutenbergEnv === '' ) {
		gutenbergEnv = 'wpcom';
	}
	return gutenbergEnv.toLowerCase();
}
