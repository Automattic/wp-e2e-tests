...
export function startBrowser( { useCustomUA = true, resizeBrowserWindow = true } = {} ) {
	...
	console.log( '~~~~~~~~~~~~~~~~~~~~' );
	console.log( 'Starting CHROME in DISPLAY:' + process.env.DISPLAY );
	console.log( '~~~~~~~~~~~~~~~~~~~~' );
...
export async function clearCookiesAndDeleteLocalStorage( driver ) {
	...
	return await this.deleteLocalStorage( driver );
}
...
export async function ensureNotLoggedIn( driver ) {
	...
	return await this.clearCookiesAndDeleteLocalStorage( driver );
}
