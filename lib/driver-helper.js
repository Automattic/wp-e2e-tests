...
export async function clickWhenClickable( driver, selector, waitOverride ) {
	const timeoutWait = waitOverride ? waitOverride : explicitWaitMS;

	await driver.sleep( 2000 ); // temp
	await this.waitTillPresentAndDisplayed( driver, selector, timeoutWait );
