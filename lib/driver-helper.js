...
export async function clearCache( driver ) {
	...
	const clearCacheSelector = by.css( '* /deep/ #clearBrowsingDataConfirm' );
	const optionCheckboxesSelector = by.css( '* /deep/ #checkbox' );

	// wait for the checkboxes to appear
	await isEventuallyPresentAndDisplayed( driver, optionCheckboxesSelector );

	// toggle all the checkboxes
	await clickWhenClickable( driver, optionCheckboxesSelector );

	// wait for the button to appear
	await isEventuallyPresentAndDisplayed( driver, clearCacheSelector );

	// click the button to clear the cache
	await clickWhenClickable( driver, clearCacheSelector );
