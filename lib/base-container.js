...
export default class BaseContainer {
	...
	setABTestControlGroupsInLocalStorage( culture = 'en', flow = 'main', personalPlanValue = 'hide' ) {
		...
		const expectedABTestValue = `{"${signupStoreKey}":"${signupStoreValue}","${browserNotificationsKey}":"${browserNotificationsValue}","${domainSuggestionPopoverKey}":"${domainSuggestionPopoverValue}","${domainSuggestionsClickableRowKey}":"${domainSuggestionsClickableRowValue}","${signupStoreBenchmarkingKey}":"${signupStoreBenchmarkingValue}"}`;
