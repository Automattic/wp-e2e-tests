...
function login( wp, account ) {
	...
	options.redirectTo = `https://public-api.wordpress.com/oauth2/authorize/?client_id=${
		options.clientId
	}&redirect_uri=${
		options.redirectUri
	}&response_type=code&scope=global&jetpack-code&jetpack-user-id=0&action=oauth2-login`;
