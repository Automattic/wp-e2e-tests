...
export default class GoogleFlow {
	...
	search( query, data ) {
		...
		this.GoogleSearchPage.getAdUrl().then( console.log );
		this.GoogleSearchPage.getAdHeadline().then( console.log );
		this.GoogleSearchPage.getAdText().then( console.log );
		this.GoogleSearchPage.getAdVisibleUrl().then( console.log );
		this.GoogleSearchPage.getAdPosition().then( console.log );
