...
export default class LoginFlow {
	...
	*/
	...
	loginAndStartNewPost() {
		...
		// Set AB tests
		let editorPage = new EditorPage( this.driver );
		return this.driver.getCurrentUrl().then( ( urlDisplayed ) => {
			return editorPage.setABTestControlGroupsInLocalStorage( urlDisplayed );
		} );		
	}
