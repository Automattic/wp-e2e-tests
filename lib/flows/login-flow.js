...
export default class LoginFlow {
	...
	*/
	...
	login() {
		...
		this.loginPage = new LoginPage( this.driver, true );
		this.loginPage.login( testUserName, testPassword );

		return this.readerPage = new ReaderPage( this.driver, true ); //Navigate to the actual Reader page we wish to use
	}
