...
export default class LoginFlow {
	...
	loginAndStartNewPost( siteURL = null ) {
		if (
			siteURL ||
	...
	loginAndStartNewPage( site = null ) {
		this.loginAndSelectMySite( site );
	...
	loginAndSelectMySite( site = null ) {
		this.login();
		...
		return new StatsPage( this.driver ).waitForPage();
	}
