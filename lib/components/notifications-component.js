...
export default class NotificationsComponent extends BaseContainer {
	...
	selectCommentByText( commentText ) {
		const self = this;
		const commentSelector = by.css( 'div > div.wpnc__text-summary > div:nth-child(1)' );
		this.driver.findElement( by.css( 'div.wpnc__excerpt' ) ).getText().then( function( selectedCommentText ) {
			if( selectedCommentText === commentText ) {
