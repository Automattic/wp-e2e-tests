...
export default class PostEditorSidebarComponent extends BaseContainer {
	...
	waitForSuccessViewPostNotice() {
		const successNoticeSelector = By.css( '.post-editor__notice.is-success,.post-editor-notice.is-success' );
	...
	addNewCategory( category ) {
		...
		const saveCategoryButtonSelector = By.css( 'div.category-selector__add-category-dialog button.is-primary' );
		const driver = this.driver;
