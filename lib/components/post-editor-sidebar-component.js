...
export default class PostEditorSidebarComponent extends BaseContainer {
	...
	addNewCategory( category ) {
		...
		const categoryNameInputSelector = By.css( 'div.term-tree-selector__add-term-dialog input[type=text]' );
		const saveCategoryButtonSelector = By.css( 'div.term-tree-selector__add-term-dialog button.is-primary' );
		const driver = this.driver;
