...
export default class SidebarComponent extends BaseContainer {
	...
	ensureSidebarMenuVisible() {
		...
		return this.driver.findElement( sidebarSelector ).isDisplayed()
			.then( sidebarVisible => !sidebarVisible ? driverHelper.clickWhenClickable( this.driver, allSitesSelector ) : false )
