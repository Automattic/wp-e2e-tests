...
export default class FindADomainComponent extends BaseContainer {
	...
	declineGoogleApps() {
		return driverHelper.clickWhenClickable( this.driver, this.declineGoogleAppsLinkSelector );
	}
	...
	selectPreviousStep() {
		return driverHelper.clickWhenClickable( this.driver, By.css( 'a.previous-step' ) );
	}
}
