...
class SiteSelectorComponent extends BaseContainer {
	constructor( driver ) {
		...
		this.firstSiteSelector = By.css( 'div.site-selector-modal.themes__site-selector-modal.dialog__content > div.sites-dropdown.is-open > div > div.sites-dropdown__selected > div > a' );
	}
