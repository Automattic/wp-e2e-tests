...
export default class SecurePaymentComponent extends BaseContainer {
	...
	enterTestCreditCardDetails( { cardHolder, cardNumber, cardExpiry, cardCVV, cardCountryCode, cardPostCode } ) {
		...
		driverHelper.setWhenSettable( this.driver, By.id( 'number' ), cardNumber, { pauseBetweenKeysMS: pauseBetweenKeysMS } );
		...
		return driverHelper.setWhenSettable( this.driver, By.id( 'postal-code' ), cardPostCode, { pauseBetweenKeysMS: pauseBetweenKeysMS } );
	}
