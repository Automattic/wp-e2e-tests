...
export default class AddEditProductPage extends BaseContainer {
	...
	setDimensions( length, width, height ) {
		driverHelper.setWhenSettable( this.driver, this._dimentionSelector( 'length' ), length );
		driverHelper.setWhenSettable( this.driver, this._dimentionSelector( 'width' ), width );
		return driverHelper.setWhenSettable( this.driver, this._dimentionSelector( 'height' ), height );
	}
