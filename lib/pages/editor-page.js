...
export default class EditorPage extends BaseContainer {
	...
	async uploadMedia( fileDetails ) {
		...
		return await self.sendFile( newFile );
	}
	...
	async sendFile( file ) {
		...
		await driver.findElement( this.fileNameInputSelector ).sendKeys( file );
		await driver.wait(
	...
	waitForImageEditor() {
		...
		return driver.wait(
			function() {
				return driverHelper
					.isElementPresent( driver, imageEditorPlaceholderSelector )
	...
	async deleteMedia() {
		...
		const deleteButton = await driver.findElement( deleteSelector );
		await driver.wait(
		...
		await driver.findElement( acceptSelector ).click();
		return await driver.wait(
	...
	async dismissMediaModal() {
		...
		await driver.findElement( cancelSelector ).click();
		return await driver.wait(
	...
	waitForTitle() {
		...
		driver.wait(
			function() {
				return driverHelper
					.isElementPresent( driver, titleLoadingSelector )
					.then( function( present ) {
						return ! present;
					} );
			},
