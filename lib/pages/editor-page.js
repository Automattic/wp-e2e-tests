...
export default class EditorPage extends BaseContainer {
	...
	insertContactForm() {
		...
		return driverHelper.clickWhenClickable( this.driver, by.css( 'button[data-e2e-button="confirm"]' ) );
	}
	...
	enterPostImage( fileDetails ) {
		...
		return driverHelper.clickWhenClickable( self.driver, by.css( 'button[data-e2e-button="accept"]' ) );
	}
