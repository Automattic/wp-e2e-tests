...
export default class StatsPage extends BaseContainer {
	...
	openIsights() {
		...
		return this.expandNavIfMobile().then( () =>
			driverHelper.clickWhenClickable( this.driver, insightsSelector )
		);
	}
	...
	openActivity() {
		...
		return this.expandNavIfMobile().then( () =>
			driverHelper.clickWhenClickable( this.driver, activitySelector )
		);
	}
