...
export default class WPAdminPluginsPage extends BaseContainer {
	...
	updateJetpack() {
		...
		return driverHelper.clickIfPresent( this.driver, updateSelector )
		.then( () => driverHelper.waitTillPresentAndDisplayed( this.driver, updatedSelector, this.explicitWaitMS * 3 ) );
	}
}
