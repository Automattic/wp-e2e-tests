...
export default class WPAdminAddPostPage extends BaseContainer {
	...
	publish() {
		...
		driverHelper.clickWhenClickable( this.driver, publishSelector ); // Sometimes the first click doesn't register  ¯\_(ツ)_/¯
		driverHelper.waitTillPresentAndDisplayed( this.driver, by.css( '#message.updated' ) );
	}
}
