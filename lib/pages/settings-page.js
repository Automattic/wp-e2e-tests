...
export default class SettingsPage extends BaseContainer {
	...
	disconnectSite() {
		...
		// TODO: Remove this once disconnection survey is released to production
		if ( DriverHelper.isEventuallyPresentAndDisplayed( this.driver, By.css( '.disconnect-jetpack-dialog' ) ) ) {
