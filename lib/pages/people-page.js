...
export default class PeoplePage extends BaseContainer {
	constructor( driver ) {
		...
		this.pendingInviteSelector = By.css( '.people-list-item__invite-resend' );
	}
	...
	pendingInviteLabelDisplayed() {
		return DriverHelper.isElementPresent( this.driver, this.pendingInviteSelector );
	}
}
