...
export default class ViewPostPage extends BaseContainer {
	...
	categoryDisplayed() {
		return this.driver.findElement( By.css( 'span.cat-links a[rel="category tag"],footer.entry-meta a[rel="category tag"],.post-categories a[rel="category tag"],.categories-links a[rel="category tag"]' ) ).getText();
	};

	tagDisplayed() {
		return this.driver.findElement( By.css( '.tags-links a[rel=tag],footer.entry-meta a[rel=tag],.tag-links a[rel=tag],.post-tags a[rel=tag]' ) ).getText();
	};
