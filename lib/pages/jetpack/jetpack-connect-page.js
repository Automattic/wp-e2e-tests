...
export default class JetpackConnectPage extends BaseContainer {
	...
	addSiteUrl( url ) {
		...
		let confirmButtonSelector = By.css( '.jetpack-connect__main .jetpack-connect__connect-button:not([disabled])' );

		return driverHelper.setWhenSettable( this.driver, urlInputSelector, url )
