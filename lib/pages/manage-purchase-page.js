...
export default class ManagePurchasePage extends BaseContainer {
	...
	confirmCancelDomain() {
		return driverHelper.clickWhenClickable( this.driver, by.css( '.cancel-purchase__button' ) );
	}
	...
	waitTillRemoveNoLongerShown() {
		return driverHelper.waitTillNotPresent( this.driver, this.removeButtonConfirmSelector, this.explicitWaitMS * 3 );
	}
}
