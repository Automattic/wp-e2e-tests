...
export default class CustomizerPage extends BaseContainer {
	...
	setHeaderImage( fileDetails ) {
		...
		self.driver.wait( driverHelper.elementIsNotPresent( this.driver, '.media-uploader-status.uploading' ), this.explicitWaitMS, 'The uploading status is still present' );
