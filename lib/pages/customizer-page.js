...
export default class CustomizerPage extends BaseContainer {
	...
	checkMenu( menuItemName1, menuItemName2 ) {//it's better to move it to separate class which refers to WP landing
		this.driver.findElement( by.xpath( '//*[@id="primary-menu"]//li[1]' ) ).getText().then( ( menu1 ) => {
			assert.equal( menu1, menuItemName1 );
		} );

		this.driver.findElement( by.xpath( '//*[@id="primary-menu"]//li[2]' ) ).getText().then( ( menu2 ) => {
