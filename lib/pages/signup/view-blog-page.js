...
export default class ViewBlogPage extends BaseContainer {
	...
	async waitForTrampolineWelcomeMessage() {
		...
		let trampolineElement = await this.driver.findElement( this.trampolineSelector );
	...
	async isTrampolineWelcomeDisplayed() {
		return await driverHelper.isElementPresent( this.driver, this.trampolineSelector );
	}
}
