...
export default class AboutPage extends BaseContainer {
	...
	enterSiteDetails( siteTile, siteTopic, { showcase = false, share = false, sell = false, educate = false, promote = false } = {} ) {
		driverHelper.setWhenSettable( this.driver, By.css( '#siteTitle' ), siteTile );
