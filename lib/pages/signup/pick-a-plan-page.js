...
export default class PickAPlanPage extends BaseContainer {
	...
	selectFreePlan() {
		return driverHelper.clickWhenClickable( this.driver, By.css( 'table button.is-free-plan' ) );
	}
	selectPersonalPlan() {
		return driverHelper.clickWhenClickable( this.driver, By.css( 'table button.is-personal-plan' ) );
	}
	selectPremiumPlan() {
		return driverHelper.clickWhenClickable( this.driver, By.css( 'table button.is-premium-plan' ) );
	}
	selectBusinessPlan() {
		return driverHelper.clickWhenClickable( this.driver, By.css( 'table button.is-business-plan' ) );
	}
	compare() {
