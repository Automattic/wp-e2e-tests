...
export default class JetpackComFeaturesDesignPage extends BaseContainer {
	...
	installJetpack() {
		...
		const installJetpackSelector = By.css( '.feature-letsgetstarted-main #btn-singlefeature-install' );

		return driverHelper.clickWhenClickable( this.driver, getStartedSelector )
