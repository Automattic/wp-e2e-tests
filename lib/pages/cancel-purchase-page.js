...
export default class CancelPurchasePage extends BaseContainer {
	...
	completeCancellationSurvey() {
		...
		driverHelper.setWhenSettable( this.driver, by.css( `${ dialogClass } input[name="anotherReasonOneInput"]` ), 'e2e testing' );
		driverHelper.clickWhenClickable( this.driver, by.css( `${ dialogClass } input[value="anotherReasonTwo"]` ) );
		driverHelper.setWhenSettable( this.driver, by.css( `${ dialogClass } input[name="anotherReasonTwoInput"]` ), 'e2e testing' );
		driverHelper.clickWhenClickable( this.driver, by.css( `${ buttonDialogClass } button[data-e2e-button="next"]` ) );
		driverHelper.setWhenSettable( this.driver, by.css( `${ dialogClass } textarea[name="improvementInput"]` ), 'e2e testing' );
