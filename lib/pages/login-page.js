...
export default class LoginPage extends BaseContainer {
	...
	googleLogin() {
		const driver = this.driver;
		return driverHelper.waitTillNotPresent( driver, By.css( '.social-buttons__button.button.disabled' ) )
		.then( () => driverHelper.clickWhenClickable( driver, By.css( '.social-buttons__button' ) ) );
	}
}
