...
export default class EmailClient {
	 ...
	 */
	// async getEmailsByRecipient( emailAddress, validator ) {
	...
	// 	// } );
	// 	// return d.promise;
	// 	let emails = await this.mailbox.getEmailsByRecipient( emailAddress );
	// 	if ( validator( emails ) ) {
	// 		return emails;
	// 	}
	// 	// if ( emails ) {
	...
	async pollEmailsByRecipient( emailAddress ) {
		return await this.mailbox.getEmailsByRecipient( emailAddress );
	}
}
