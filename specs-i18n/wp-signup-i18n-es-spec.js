...
test.describe( 'WordPress.com Sign Up', function() {
	...
	test.it( 'Can Create A Free Blog (es) Desktop', function() {
		const signupFlow = new SignUpFlow( driver, 'desktop' );
		signupFlow.createFreeBlogWithScreenshots( 'es' );
	} );

	test.it( 'Can Create A Free Blog (es) Tablet', function() {
		const signupFlow = new SignUpFlow( driver, 'tablet' );
		signupFlow.createFreeBlogWithScreenshots( 'es' );
	} );

	test.it( 'Can Create A Free Blog (es) Mobile', function() {
