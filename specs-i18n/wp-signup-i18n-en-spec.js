...
test.describe( 'WordPress.com Sign Up', function() {
	...
	test.it( 'Can Create A Free Blog (en) Desktop', function() {
		const signupFlow = new SignUpFlow( driver, 'desktop' );
		signupFlow.createFreeBlogWithScreenshots( 'en' );
	} );

	test.it( 'Can Create A Free Blog (en) Tablet', function() {
		const signupFlow = new SignUpFlow( driver, 'tablet' );
		signupFlow.createFreeBlogWithScreenshots( 'en' );
	} );

	test.it( 'Can Create A Free Blog (en) Mobile', function() {
