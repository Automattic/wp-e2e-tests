...
test.describe( 'WordPress.com Sign Up', function() {
	...
	test.it( 'Can Create A Free Blog (it) Desktop', function() {
		const signupFlow = new SignUpFlow( driver, 'desktop' );
		signupFlow.createFreeBlogWithScreenshots( 'it' );
	} );

	test.it( 'Can Create A Free Blog (it) Tablet', function() {
		const signupFlow = new SignUpFlow( driver, 'tablet' );
		signupFlow.createFreeBlogWithScreenshots( 'it' );
	} );

	test.it( 'Can Create A Free Blog (it) Mobile', function() {
