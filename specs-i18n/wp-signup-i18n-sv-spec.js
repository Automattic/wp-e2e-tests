...
test.describe( 'WordPress.com Sign Up', function() {
	...
	test.it( 'Can Create A Free Blog (sv) Desktop', function() {
		const signupFlow = new SignUpFlow( driver, 'desktop' );
		signupFlow.createFreeBlogWithScreenshots( 'sv' );
	} );

	test.it( 'Can Create A Free Blog (sv) Tablet', function() {
		const signupFlow = new SignUpFlow( driver, 'tablet' );
		signupFlow.createFreeBlogWithScreenshots( 'sv' );
	} );

	test.it( 'Can Create A Free Blog (sv) Mobile', function() {
