...
test.describe( 'WordPress.com Sign Up', function() {
	...
	test.it( 'Can Create A Free Blog (de) Desktop', function() {
		const signupFlow = new SignUpFlow( driver, 'desktop' );
		signupFlow.createFreeBlogWithScreenshots( 'de' );
	} );

	test.it( 'Can Create A Free Blog (de) Tablet', function() {
		const signupFlow = new SignUpFlow( driver, 'tablet' );
		signupFlow.createFreeBlogWithScreenshots( 'de' );
	} );

	test.it( 'Can Create A Free Blog (de) Mobile', function() {
