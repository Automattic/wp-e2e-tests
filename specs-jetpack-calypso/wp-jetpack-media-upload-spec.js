...
test.describe( host + ' Jetpack Editor: Media Upload (' + screenSize + ')', function() {
	...
	test.describe( 'Image Upload:', function() {
		...
		test.describe( 'Can upload many media types', () => {
			...
			// Can't upload an MP3 to a Jetpack site in Calypso
			// https://github.com/Automattic/wp-calypso/issues/10830
			test.xdescribe( 'Can upload an mp3', function() {
				let fileDetails;
